...
//积分支付成功Dialog
public class TicketAdd_Dialog extends BaseDialogFragment {
    ...
    public static TicketAdd_Dialog newInatance() {
        Bundle args = new Bundle();
        TicketAdd_Dialog pays_dialog = new TicketAdd_Dialog();
    ...
    protected int getLayoutRes() {
        return R.layout.onlinecourse_dialogs;
    }
